...
(defun %json-object (&rest pairs)
  (json-kit:alist->json-object (remove nil pairs) :duplicate-key-policy :error))
...
(defun %json-object-with-field (object key value)
  (let* ((members (%json-object-members object))
    ...
    (json-kit:alist->json-object (append without-key (list (cons key value)))
